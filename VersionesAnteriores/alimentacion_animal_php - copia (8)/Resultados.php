...
Class resultados{
    ...
    function status_animal(){
        ...
        echo $animales_anadir[$num_menu][1]."= animal"; //estatus_animal
        echo $animales_anadir[$num_menu][2]."=peso_animal";
        echo $animales_anadir[$num_menu][3]."= MER_calorias";
        echo $animales_anadir[$num_menu][4]."= num_menu";
    ...
    function alimentos(){
            ...
            foreach($array_alimentos_escogidos as $aae){
                       ...
                       // global $animales_anadir;
                        ...
                        $relleno_Calorias_Menu_csv->anadir_alimento_a_menu($animales_anadir);                        
