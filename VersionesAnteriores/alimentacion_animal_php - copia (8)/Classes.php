...
date_default_timezone_set('UTC');
    ...
    Class rellenar_Calorias_Menu{
            ...
            //menu = alimentos con el mismo $ind_menu
                ...
                function calcular_id_menu($cal_menu){
                    ...
                    return $num_ind_menu_a_ocupar = $max_ind_menu_ocupados+1;
                
                }
                function anadir_alimento_a_menu($menu_array_nuevo){
                    global $row;
                    global $num_ind_menu_a_ocupar;
                ...
                function reconstruir_Calorias_Menu($cal_menu){
                    ...
                    if (($handle = fopen("Calorias_Menu.csv", "w")) !== FALSE) {
                        ...
                        echo "registro que se grava ".$txt;
                        fwrite($handle, $txt);
